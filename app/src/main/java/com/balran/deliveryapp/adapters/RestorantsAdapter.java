...
public class RestorantsAdapter extends RecyclerView.Adapter<RestorantsAdapter.viewHolderAdapterChatList> {
    List<Restorant> mValues;
    Context ctx;

    public RestorantsAdapter(List<Restorant> restorantList, Context ctx) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RestorantsAdapter.viewHolderAdapterChatList holder, int position) {
        if(mValues!=null){
            ...
            holder.cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    DashboardActivity.restorantFoods(Integer.parseInt(holder.mItem.getIdrestorant()), holder.mItem.getUserId());
                }
            });
        }
    }
